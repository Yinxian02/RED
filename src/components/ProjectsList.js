const projectsList = [
  ...
  },
  {
    ...
    paragraph: "Drawing from the past three experiences, the 2019 team developed strategies to improve and optimise building design and construction efficiency.",
  ...
  },
  {
    ...
    paragraph: "The 2018 RED team continued to touch the lives of the rural community at Kampung Kuala Punteh by constructing an education centre, replicating the original design.",
  ...
  },
  {
    ...
    paragraph: "Following the success of the pilot project, the 2017 team of nineteen volunteers replicated the design of the first building in Kampung Palipikan, completing construction in five weeks. An off-grid solar system was also incorporated for electricity supply.",
  ...
  },
  {
    ...
    paragraph: "Building on the feasibility studies, RED launched its pilot project in Kampung Gaur with fourteen volunteers from Imperial College London. A single storey 6m x 9m education centre was constructed in 6 weeks, equipped with a rainwater harvesting tank.",
    reportLink: null,
    youtubeLink: null
  },
  {
